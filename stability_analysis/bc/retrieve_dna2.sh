...
for x in $(cat indivs); do
	...
	aws s3 cp s3://jacob-pqe/${x}_1/dna/${DNASRR1}_genefamilies.tsv /home/ubuntu/data/dna2/${x}_dna_1.tsv
	sed -i "s/SRR.*RPKs/${x}_dna_1/g" /home/ubuntu/data/dna/${x}_dna_1.tsv
	aws s3 cp s3://jacob-pqe/${x}_2/dna/${DNASRR2}_genefamilies.tsv /home/ubuntu/data/dna2/${x}_dna_2.tsv
        sed -i "s/SRR.*RPKs/${x}_dna_2/g" /home/ubuntu/data/dna/${x}_dna_2.tsv
	aws s3 cp s3://jacob-pqe/${x}_3/dna/${DNASRR3}_genefamilies.tsv /home/ubuntu/data/dna2/${x}_dna_3.tsv
        sed -i "s/SRR.*RPKs/${x}_dna_3/g" /home/ubuntu/data/dna/${x}_dna_3.tsv
	aws s3 cp s3://jacob-pqe/${x}_4/dna/${DNASRR4}_genefamilies.tsv /home/ubuntu/data/dna2/${x}_dna_4.tsv
        sed -i "s/SRR.*RPKs/${x}_dna_4/g" /home/ubuntu/data/dna/${x}_dna_4.tsv
done
humann2_join_tables --input /home/ubuntu/data/dna2/ --output /home/ubuntu/data/dna.txt
