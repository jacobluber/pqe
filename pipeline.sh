...
cat ${DNA}_1.fastq ${DNA}_2.fastq > ${DNA}.fastq
mv ${DNA}_1.fastq ${INDIV}_${TIME}/dna
mv ${DNA}_2.fastq ${INDIV}_${TIME}/dna
...
cat ${RNA}_1.fastq ${RNA}_2.fastq > ${RNA}.fastq
mv ${RNA}_1.fastq ${INDIV}_${TIME}/rna
mv ${RNA}_2.fastq ${INDIV}_${TIME}/rna
